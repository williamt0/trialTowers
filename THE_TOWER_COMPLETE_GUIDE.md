# THE TOWER — COMPLETE DESIGN, ART & ANIMATION GUIDE
> **One file, everything.** Designs of every character / NPC / enemy / object and their movement, the full art-generation rules, how to **design & generate the animations**, ready-to-paste AI prompts, and the exact list of art still to draw. Consolidated from the project's five design docs. Generated against `web/game.js` @ v230.
>
> **Golden rule:** the game runs with ZERO art — every PNG you add *overrides* one procedural sprite. Resolution order: animation frames → static PNG → generated fallback. So generate art in any order; it just drops in.
>
> **The 4 hard rules for any sprite:** face RIGHT (engine flips) · transparent background (engine bakes the contour/shadow) · animation frames numbered **contiguously from `_1`** (≤16, ~10 fps) · bump `ASSET_VER` (statics) / `ANIM_VER` (anim frames) after adding, or the browser serves the cached old image.

## MASTER CONTENTS
- **PART 1 — Complete Design & Behavior Spec** — every entity's look, movement, AI, stats + the technical art bible (the authoritative *current* data). Has its own §0–§7.
- **PART 2 — Animation Generation Guide** — how to produce smooth idle/walk/attack frames (the *designs of the animation*).
- **PART 3 — AI Prompt Library & Style Bible** — ready-to-paste generation prompts per asset, global style suffix, realm palettes, generation order. ⚠ *floor numbers in this part predate the Molten Heart insert (its "F10 Crown" is now F11) — trust PART 1 for the current floor→realm mapping.*
- **PART 4 — Art To-Draw Checklist** — exact missing filenames, adversarially verified.

---

## PART 1 — COMPLETE DESIGN & BEHAVIOR SPEC
_Every class, enemy, NPC, prop, structure, wall, item — appearance, movement, AI, stats — plus the technical asset/animation bible. Authoritative for the current build (v230)._
...
## PART 2 — ANIMATION GENERATION GUIDE
_How to make the frames move smoothly — sprite strips, frame counts, the golden rules, prompt templates, and the image-to-video route._
...
## PART 3 — AI PROMPT LIBRARY & STYLE BIBLE
_Ready-to-paste prompts per asset + the global style suffix, realm palettes, and the recommended generation order. ⚠ Floor numbers below predate the Molten Heart insert — see PART 1 for the current 11-floor mapping; the prompt text & style guidance are still valid._

### 3A · Visual Overhaul Manifest (style bible, palettes, per-asset prompt cores, generation order)
...
### 3B · Character & Item Prompt List (per-entry ready-to-paste prompts)

*A complete manifest for AI image generation. Every entry is written as a ready-to-paste prompt.*

### Recommended style prefix (paste before every prompt)
> cute chibi fantasy game sprite, top-down 3/4 view, flat cel shading, bold dark outline, soft rim light, transparent background, centered, single subject, no text

Keep one consistent seed/style per batch. Suggested sizes: creatures 256×256, bosses 512×512, items 128×128, tiles 512×512.

---

### 1 · HEROES (player classes)
| Name | Prompt |
|---|---|
| **Knight** | stout armored knight, steel-blue plate armor #5A82D2, round helm with red plume, kite shield and short sword, brave grin |
| **Ranger** | hooded forest archer, deep green cloak #3A6342, longbow drawn, leather bracers, sharp calm eyes |
| **Mage** | small robed mage, indigo-violet robe #7884EB, wide pointed hat with pale band, glowing orb staff, sparkles |
| **Rogue** | nimble hooded rogue, charcoal garb #3A3A46, crimson scarf #8C2F3A, twin daggers reversed grip, sly smirk |

### 2 · TOWNSFOLK / NPCs
| Name | Prompt |
|---|---|
| **The Sage** | elderly robed sage, pale blue robe #78AAEB, long white beard, knowing smile, lantern staff |
| **The Herald** | royal messenger, orange tabard #FFB950, carries a tall quest banner with “!” sigil |
| **The Merchant** | plump cheerful trader, gold-trimmed coat #E6C85A, coin pouch on belt, open palms |
| **The Healer** | gentle cleric, white robe with red cross, green sash #78DC8C, healing light in hands |
| **The Smith** | burly blacksmith, leather apron #5A4A3A, raised hammer, small anvil, soot smudges |
| **The Guard** | town guard, steel kettle-helm with red plume, grey-blue uniform #A0AAC8, spear and stern face |
| **The Scholar** | bookish scholar, violet robe #C8B4FF, round glasses, oversized tome under arm |
| **The Cook** | jolly cook, tall white chef hat, peach apron #F0AA78, wooden ladle, steam curls |
| **The Gambler** | sly gambler, plum vest #DC8CC8, playing card fanned in hand, raised eyebrow |
| **The Bard** | traveling bard, teal cap with yellow feather #96DCDC, small lute, mid-song |
| **The Monk** | serene monk, bald head, sand-green robe #B4C8A0, wooden prayer beads |
| **The Innkeeper** | warm innkeeper, tan apron #E6BE8C, foaming mug, towel over shoulder |
| **The Farmer** | sun-browned farmer, wide straw hat #D8B85A, pitchfork, hay-green tunic #C8D28C |
| **The Child** | tiny villager child, oversized tunic #FFD2AA, big curious eyes, pointing excitedly |
| **The Wanderer / Local** | weathered traveler, grey cloak #C8C8D4, walking stick, faraway look |
| **The Trapper (jungle folk)** | scarred jungle trapper, leaf-green poncho, rope coils, machete on hip |

### 3 · CREATURES (by floor)
#### Floor 1 — The Trial Grounds (palette accent #96D278)
| **Slime** | round green training slime #73D966, glossy, droplet on head, simple happy face |
| **Darter** | small pink dart-beast #E85D9B, sleek teardrop body, zigzag speed lines |
| **Trial Mimic** *(elite)* | pale-green slime with a cracked mask, splits into two smaller slimes, mischievous |

#### Floor 2 — The Verdant Jungle (#6ECD5A)
| **Vine Snapper** | carnivorous plant-blob #5AC850, leaf sprouts on head, toothy grin, vine tendrils |
| **Jade Prowler** | jade jungle cat #46AA64, low stalking pose, long tail, glowing eyes |
| **Dart Frog** | golden poison frog #F0B43C, bulging eye-stalks, spotted back |
| **Stinger Drone** | yellow wasp-bug #DCC85A, translucent wings, twin antennae, needle sting |
| **Silverback** *(elite)* | hulking silver-grey ape #AAAAB4, heavy brow, knuckle stance, white aura ring |

#### Floor 3 — The Human Empire (#78AAEB)
| **Legionnaire** | small imperial soldier, blue-steel helm with plume #96AADC, short sword, tower shield |
| **Arbalist** | imperial crossbowman, navy quilted armor #788CC8, loaded crossbow |
| **War Hound** | armored war dog #96825F, spiked collar, bared teeth |
| **Imperial Sentry** *(elite)* | immobile sentry automaton-knight #EBCD6E, halberd planted, watchful visor |

#### Floor 4 — The 獸人族 Empire (#EB963C)
| **Pack Wolf** | tawny wolf #B98C5A, lean, hunting crouch, pack-mark warpaint |
| **Tusked Bruiser** | boar-built beastman #CD7846, jutting tusks, shoulder hump |
| **Spear Hunter** | beastfolk hunter #D7A055, fur mantle, bone-tipped spear |
| **Ambush Hunter** *(elite)* | chameleon-furred stalker #5AD7CD, semi-transparent, lunging claws |

#### Floor 5 — The Elves Forest (#78D26E)
| **Grove Warden** | elven warden #8CDC82, leaf-blade bow, calm and poised |
| **Blade Dancer** | elven duelist #AFE696, twin leaf-swords mid-pirouette |
| **Treant Sapling** | walking sapling #6EAA5A, bark body, mossy crown, sleepy face |
| **Spirit Wisp** *(elite)* | teleporting mote of light #B9AFFF, trailing sparks, tiny halo |

#### Floor 6 — The 魔物 Empire (#C85AA0)
| **Horned Impling** | grinning pink imp #E173A5, curved horns, arrow-tip tail |
| **Hex Caster** | horned warlock #C35FCD, ragged robe, hex sigil floating at palm |
| **Horned Brute** | massive horned ogre #AF557D, knuckles down, cracked tusks |
| **Bomb Fiend** | round red bomb-imp #E65F55, lit fuse on head, manic grin |
| **Voidling** *(elite)* | purple void-slime #C37DFF, leaks starfield, detonates in static |

#### Floor 7 — Peak of the Two Families (#F5E196)
| **House Blade** | sword-house duelist, cream-gold uniform #EBDCAA, single perfect katana |
| **House Arcanist** | magic-house adept, violet-silver robe #B99BFF, twin floating glyphs |
| **Family Adept** *(elite)* | prodigy in half-sword half-robe attire #FFEEA5, three fanned light-blades |

#### Floor 8 — Court of the Upper Beings (#B46EFF)
| **Vampire Thrall** | pale bat-winged servant #DC5F69, red collar, fangs |
| **Spiritling** | blinking light-spirit #AFEBFF, halo, mischievous |
| **Drakeling** | young copper dragon #EB9641, stubby wings, ember breath |
| **Felguard** | violet demon guard #B973FF, tower pauldrons, fel glow |
| **Bloodbat** *(elite)* | great crimson bat #EB5F73, ribbed wings, life-drain mist |

#### Floor 9 — The Hall of Echoes (#96D7FF)
| **Climber Shade** | translucent ghost of a fallen adventurer #96C8EB, hollow eyes, wavering hem |
| **Echo Archer** | spectral archer #87B9E1, half-faded bow, sorrowful |
| **Chillbound Shade** *(elite)* | frost-wreathed ghost #96D7FF, icy chains, freezing touch |

#### Floor 10 — The Tower's Crown (#FFEBAA)
| **Crown Seraph** | small radiant winged guardian #FFEBAA, halo, spear of light |
| **Crown Templar** | gold-armored sentinel #F0DC9B, sun emblem shield |

#### Everywhere
| **Monster Nest** | dark egg mound #46373F, three pale eggs, dripping ooze, hatching crack |

### 4 · BOSSES & GATEKEEPERS
| **Warden of First Steps** (F1) | stone-armored trial golem, judge's gavel-hammer, kind-but-stern glowing eyes |
| **Mossback, the Trial Tortoise** (F1 alt) | ancient moss-covered tortoise, ruins on shell, slow wise gaze |
| **The Bellringer of Beginnings** (F1 alt) | robed figure swinging a cracked bronze bell, sound rings visible |
| **Raukan, the Jungle Tyrant** (F2) | colossal jade panther-ape #50B450, vine-wrapped limbs, roaring, crown of orchids |
| **Grand Marshal** (F3) | towering human commander, gleaming blue-steel plate, cape, greatsword planted |
| **Khan of the 獸人族** (F4) | beastfolk warlord, lion mane, trophy necklace, twin axes |
| **High Keeper of the Elder Grove** (F5) | serene elven archdruid, antler crown, robes of living leaves |
| **Horned Sovereign of the 魔物** (F6) | regal demon monarch, sweeping horns, magma-vein skin, floating crown |
| **劍聖 — Patriarch of the Blade** (F7) | white-haired sword saint, simple robe #EBE1B4, single katana, absolute stillness |
| **法聖 — Matriarch of the Arcane** (F7) | silver-haired magic matriarch #B496FF, constellation robe, staff of glass |
| **The Crimson Count — Vampire** (F8) | aristocrat vampire lord, high collar cloak #E65064, wine glass of mist, bat wings |
| **Aurelia — Higher Spirit** (F8) | luminous genderless spirit #AAEBFF, three halos, trailing star-ribbons |
| **Vermithrax — Elder Dragon** (F8) | ancient copper dragon #EB9641, cracked scales, hoard-dust glitter |
| **Mal'goth — 高階魔族** (F8) | high demon archfiend #B46EFF, obsidian crown-horns, void cloak |
| **The First Climber's Echo** (F9) | ghostly mirror of the player hero #96C8EB, half-faded, copies all four class weapons |
| **AETHON, Sovereign of the Tower** (F10) | radiant colossus #FFEBAA, sun-disc halo, robes of dawn light, holds a tiny model of the Tower |

### 5 · ITEMS & PROPS
| **Coin** | chunky gold coin #FFD34D, tower emblem |
| **Relic – Charm / Idol / Sigil / Totem / Relic / Amulet / Ring / Talisman / Brand / Locket / Crown / Fang** | one icon each; material themes per floor: Trial(stone-green), Jungle(vine-wood), Imperial(blue steel), Beastfang(bone), Sylvan(living leaf), Fiend(horned obsidian), Twinhouse(gold-lacquer), Sovereign(violet crystal), Echo(pale ice-glass), Crown(sun-gold) |
| **Chest (small)** | wooden chest #B8862F, green-gem clasp |
| **Chest (vault)** | grand golden chest #C79A32, glowing seams |
| **Shrine** | violet stone shrine #9B8CFF, floating orb, candle ring |
| **Healing Flower** | four color variants #FF7AB3 #FFD34D #B88CFF #7AD0FF, glowing pollen |
| **Crop** | golden wheat tuft #D8C84A on green stalk |
| **Market Stall** | wooden stall, striped canopy (red/gold/green/blue variants) |
| **Stair / Exit Gate** | glowing spiral stair portal, realm-colored ring; locked variant with chains + padlock |
| **Sword slash / bolt / ult nova** | white arc slash; cyan magic bolt #7FFFFF; expanding realm-colored shockwave ring |

### 6 · ENVIRONMENT MOOD BOARDS (one per floor)
| F1 Trial Grounds | grey-green stone training fields, dust motes, banners of beginnings |
| F2 Verdant Jungle | deep green canopy #16290F, rain bursts, giant leaves, vines |
| F3 Human Empire | blue-slate roads, walled city IMPERIA, rain over stone keeps |
| F4 獸人族 Empire | savanna trails, hide tents, bone totems, drifting leaves |
| F5 Elves Forest | luminous glades, spirit lights, sacred ponds |
| F6 魔物 Empire | ash-falling dark earth, horned obelisks, city KHORVASH |
| F7 Two Families | golden mountaintop estates, glimmer in the air, twin compounds |
| F8 Court of Upper Beings | violet void-marble court, four sanctums, drifting motes |
| F9 Hall of Echoes | snow-blue ruined hall, gravestones, faded banners |
| F10 Tower's Crown | sun-gold colonnade above the clouds, spark storms, the throne |


---

## PART 4 — ART TO-DRAW CHECKLIST (verified)
_Exact missing/partial filenames, cross-checked against disk and adversarially verified._
